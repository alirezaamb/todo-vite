          ...
          El({
            ...
            children: [
              El({
                element: 'input',
                className:
                  'rounded-md border px-2 py-1 outline-none focus:bg-gray-100 transition-all ',
                type: 'text',
                placeholder: 'Task',
                id: 'task-input',
              }),
          ...
          El({
            ...
            children: [
              El({
                element: 'select',
                className:
                  'rounded-md cursor-pointer px-2 py-1 flex flex-col h-[35px] outline-none focus:bg-gray-100 transition-all',
                name: 'Status',
                id: 'status_select',
                children: [
                  El({
          ...
          El({
            ...
            children: [
              El({
                element: 'input',
                className:
                  'rounded-md border px-2 py-1 h-[35px] outline-none focus:bg-gray-100 transition-all',
                type: 'date',
          ...
          El({
            ...
            children: [
              El({
                element: 'input',
                className:
                  'rounded-md p-5 flex flex-col gap-1 outline-none focus:bg-gray-100 transition-all',
                type: 'text',
